...
- [ ] **DShot RPM Notch Filter Bank (`src/flight/rpm_filter.hpp`)**: Motor harmonic acoustic noise tracking.
...
- [ ] **1.5 DShot RPM Filter** (`src/flight/rpm_filter.hpp` $\leftrightarrow$ `external/inav/src/main/flight/rpm_filter.c`)
